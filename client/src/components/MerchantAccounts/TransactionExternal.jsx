...
const Transaction = ({ transaction }) => {
  ...
  const accountNumber =
    transaction.remitter.account_identifiers[0].account_number;
  const sortCode = transaction.remitter.account_identifiers[0].sort_code;
  const iban = transaction.remitter.account_identifiers[1].iban;
