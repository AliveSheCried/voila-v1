...
const Transaction = ({ transaction }) => {
  ...
  const accountNumber =
    transaction.beneficiary.account_identifiers[0].account_number;
  const sortCode = transaction.beneficiary.account_identifiers[0].sort_code;
  const iban = transaction.beneficiary.account_identifiers[1].iban;
